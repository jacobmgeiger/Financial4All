# financial4all/xbrl/standardization/unmapped_logger.py
"""
...
class UnmappedTagLogger:
    ...
    def _suggest_mapping(
        ...
        suggestions = {
            ...
            ("research", "IncomeStatement"): ("ResearchAndDevelopment", 0.75),
            ("selling", "IncomeStatement"): ("SellingGeneralAndAdmin", 0.70),
            # Asset patterns

# financial4all/xbrl/standardization/reverse_index.py
"""
...
standard concepts, with support for:
...
class MappingResult:
    ...
    """List of standard concept names."""
...
class ReverseIndex:
    ...
    def get_standard_concept(
        ...
        # Log ambiguous resolution if requested
        if log_ambiguous:
            try:
    ...
    def _disambiguate_by_context(
        ...
        try:
            ...
            # Special case - if is_total is True, prefer "Total" concepts
            if is_total:
    ...
    def concept_to_display_name(self, standard_concept: str) -> str:
        ...
        Args:
            standard_concept: The standard concept name

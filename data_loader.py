...
# Load the comprehensive set of calculation formulas generated by xblr_main.py.
# This file contains the parent-child relationships for financial metrics as defined in the US-GAAP XBRL taxonomy.
with open("xblr_prep/income_statement_formulas.json", "r") as f:
...
def process_metrics(ticker: str):
    ...
    standard_is_df, alternatives = create_standard_income_statement(
        df_solved, all_results
    )

    return df_solved, standard_is_df, alternatives
...
def create_standard_income_statement(df, all_results):
    ...
    return final_df.dropna(how="all", axis=0), alternatives
